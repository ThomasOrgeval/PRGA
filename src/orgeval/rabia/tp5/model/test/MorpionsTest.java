package orgeval.rabia.tp5.model.test;

import morpions.kit.test.*;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import orgeval.rabia.tp5.model.ModeleMorpions;
import orgeval.rabia.tp5.model.SpecifModeleMorpions;
...
public class MorpionsTest {
    ...
    public void testJoueur1gagnant() {
        ...
        morpions.jouerCoup(2, 3); // J2
        morpions.jouerCoup(1, 3); // J1
        assertSame(morpions.getEtatJeu(), orgeval.rabia.tp5.model.SpecifModeleMorpions.Etat.J1_VAINQUEUR, "Le joueur 1 est gagnant");
    }
    ...
    public void testJoueur2gagnant() {
        ...
        assertSame(morpions.getEtatJeu(), orgeval.rabia.tp5.model.SpecifModeleMorpions.Etat.J2_VAINQUEUR, "Le joueur 2 est gagnant");
    }

    @Test
    public void testEtatJeu() {
        morpions.jouerCoup(1, 1);
        assertEquals(orgeval.rabia.tp5.model.SpecifModeleMorpions.Etat.J2_JOUE, morpions.getEtatJeu());
        morpions.jouerCoup(3, 3);
        assertEquals(orgeval.rabia.tp5.model.SpecifModeleMorpions.Etat.J1_JOUE, morpions.getEtatJeu());
